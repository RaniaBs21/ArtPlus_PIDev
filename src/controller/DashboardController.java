...
public class DashboardController implements Initializable {
    ...
    private Stage stage;
    @FXML
    private TableColumn<user,Integer> id_d;
    /**
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
        ImageView imageView = new ImageView(getClass().getResource("/Resources/2222.png").toExternalForm());
    ...
    private void listeUser() {
        ...
        id_d.setCellValueFactory(new PropertyValueFactory<>("id_user"));
