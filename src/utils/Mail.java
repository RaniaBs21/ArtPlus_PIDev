...
public class Mail {
    ...
    private static String username = "rania.bensalem.1@esprit.tn";
    private static String password = "yqmbkwsushowgkoj";
...
// Etape 2 : Création de l'objet Message
            ...
            message.setFrom(new InternetAddress("rania.bensalem.1@esprit.tn"));
