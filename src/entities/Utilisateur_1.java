...
public class Utilisateur_1 {
    ...
    public Utilisateur_1(String nom_ut, String prenom_ut, String password_ut, String email_ut, String adresse_ut, String num_tel_ut) {
        this.nom_ut = nom_ut;
    ...
    public Utilisateur_1(int id_ut, String nom_ut, String prenom_ut, String password_ut, String email_ut, String adresse_ut, String num_tel_ut) {
        this.id_ut = id_ut;
        this.nom_ut = nom_ut;
        this.prenom_ut = prenom_ut;
        this.password_ut = password_ut;
