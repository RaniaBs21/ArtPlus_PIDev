...
public class Sujet {
    ...
    public Sujet(int idsujet, String titresujet, String contenu, String date, int accepter, int nbcom, int iduser,int idtopic) {
     ...
     public Sujet(int idsujet, String titresujet, String contenu, String date, int accepter, int nbcom, int iduser,int idtopic,byte[] photo) {
        this.idsujet = idsujet;
        this.titresujet = titresujet;
        this.contenu = contenu;
        this.date = date;
    ...
    public String toString() {
        return "Sujet{" + "idsujet=" + idsujet + ", titresujet=" + titresujet + ", contenu=" + contenu + ", date=" + date + ", accepter=" + accepter + ", nbcom=" + nbcom + ", iduser=" + iduser + ", idtopic=" + idtopic + ", photo=" + photo + '}';
    }
